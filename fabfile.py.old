"""
Starter fabfile for deploying the webapp project.
...
# CHANGEME
env.hosts = ['user@webapp.example.com']
env.code_dir = '/srv/www/webapp'
env.project_dir = '/srv/www/webapp/webapp'
env.static_root = '/srv/www/webapp/static/'
env.virtualenv = '/srv/www/webapp/.virtualenv'
env.code_repo = 'git@github.com:user/webapp.git'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/webapp/wsgi.py" % env.code_dir)
