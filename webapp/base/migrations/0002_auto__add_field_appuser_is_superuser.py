...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppUser.is_superuser'
        db.add_column(u'base_appuser', 'is_superuser',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding M2M table for field groups on 'AppUser'
        m2m_table_name = db.shorten_name(u'base_appuser_groups')
        ...
        m2m_table_name = db.shorten_name(u'base_appuser_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('appuser', models.ForeignKey(orm[u'base.appuser'], null=False)),
    ...
    def backwards(self, orm):
        # Deleting field 'AppUser.is_superuser'
        db.delete_column(u'base_appuser', 'is_superuser')

        # Removing M2M table for field groups on 'AppUser'
        db.delete_table(db.shorten_name(u'base_appuser_groups'))

        # Removing M2M table for field user_permissions on 'AppUser'
        db.delete_table(db.shorten_name(u'base_appuser_user_permissions'))
