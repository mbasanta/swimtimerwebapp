...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Entry.heat' to match new field type.
        db.rename_column(u'swimapp_entry', 'heat_id', 'heat')
        # Changing field 'Entry.heat'
        db.alter_column(u'swimapp_entry', 'heat', self.gf('django.db.models.fields.IntegerField')(null=True))
        # Removing index on 'Entry', fields ['heat']
        db.delete_index(u'swimapp_entry', ['heat_id'])


    def backwards(self, orm):
        # Adding index on 'Entry', fields ['heat']
        db.create_index(u'swimapp_entry', ['heat_id'])
        ...
        # Renaming column for 'Entry.heat' to match new field type.
        db.rename_column(u'swimapp_entry', 'heat', 'heat_id')
        # Changing field 'Entry.heat'
