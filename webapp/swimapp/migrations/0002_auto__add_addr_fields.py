...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Meet.addr_name'
        db.add_column(u'swimapp_meet', 'addr_name',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Meet.addr'
        db.add_column(u'swimapp_meet', 'addr',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Meet.addr_city'
        db.add_column(u'swimapp_meet', 'addr_city',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Meet.addr_state'
        db.add_column(u'swimapp_meet', 'addr_state',
                      self.gf('localflavor.us.models.USStateField')(max_length=2, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Meet.addr_zip'
        db.add_column(u'swimapp_meet', 'addr_zip',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Meet.addr_country'
        db.add_column(u'swimapp_meet', 'addr_country',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Meet.course_code_2'
        db.alter_column(u'swimapp_meet', 'course_code_2_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['swimapp.CourseCode']))

        # Changing field 'Meet.meet_type_2'
        db.alter_column(u'swimapp_meet', 'meet_type_2_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['swimapp.MeetType']))

    def backwards(self, orm):
        # Deleting field 'Meet.addr_name'
        db.delete_column(u'swimapp_meet', 'addr_name')

        # Deleting field 'Meet.addr'
        db.delete_column(u'swimapp_meet', 'addr')

        # Deleting field 'Meet.addr_city'
        db.delete_column(u'swimapp_meet', 'addr_city')

        # Deleting field 'Meet.addr_state'
        db.delete_column(u'swimapp_meet', 'addr_state')

        # Deleting field 'Meet.addr_zip'
        db.delete_column(u'swimapp_meet', 'addr_zip')

        # Deleting field 'Meet.addr_country'
        db.delete_column(u'swimapp_meet', 'addr_country')


        # Changing field 'Meet.course_code_2'
        db.alter_column(u'swimapp_meet', 'course_code_2_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['swimapp.CourseCode']))

        # Changing field 'Meet.meet_type_2'
        db.alter_column(u'swimapp_meet', 'meet_type_2_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['swimapp.MeetType']))
