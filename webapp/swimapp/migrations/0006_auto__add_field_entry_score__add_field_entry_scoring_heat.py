...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'swimapp_entry', 'score',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Entry.scoring_heat'
        db.add_column(u'swimapp_entry', 'scoring_heat',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'swimapp_entry', 'score')

        # Deleting field 'Entry.scoring_heat'
        db.delete_column(u'swimapp_entry', 'scoring_heat')
