...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AthleteEntry.order'
        db.alter_column(u'swimapp_athleteentry', 'order', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'AthleteEntry.order'
        db.alter_column(u'swimapp_athleteentry', 'order', self.gf('django.db.models.fields.IntegerField')(default=0))
