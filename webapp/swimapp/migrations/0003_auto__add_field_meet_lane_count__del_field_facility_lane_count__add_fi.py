...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Meet.lane_count'
        db.add_column(u'swimapp_meet', 'lane_count',
        ...
        # Adding field 'Facility.lane_count_1'
        db.add_column(u'swimapp_facility', 'lane_count_1',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Facility.lane_count_2'
        db.add_column(u'swimapp_facility', 'lane_count_2',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Meet.lane_count'
        db.delete_column(u'swimapp_meet', 'lane_count')
        ...
        # Deleting field 'Facility.lane_count_1'
        db.delete_column(u'swimapp_facility', 'lane_count_1')

        # Deleting field 'Facility.lane_count_2'
        db.delete_column(u'swimapp_facility', 'lane_count_2')
