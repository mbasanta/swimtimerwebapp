...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Meet.end_date'
        db.alter_column(u'swimapp_meet', 'end_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Meet.meet_type'
        db.alter_column(u'swimapp_meet', 'meet_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['swimapp.MeetType']))

        # Changing field 'Meet.start_date'
        db.alter_column(u'swimapp_meet', 'start_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Meet.team'
        db.alter_column(u'swimapp_meet', 'team_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['swimapp.Team'], null=True))

        # Changing field 'Meet.course_code_1'
        db.alter_column(u'swimapp_meet', 'course_code_1_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['swimapp.CourseCode']))

        # Changing field 'Meet.meet_config'
        db.alter_column(u'swimapp_meet', 'meet_config_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['swimapp.MeetConfig'], null=True))

    def backwards(self, orm):

        # Changing field 'Meet.end_date'
        db.alter_column(u'swimapp_meet', 'end_date', self.gf('django.db.models.fields.DateTimeField')(default=1))

        # Changing field 'Meet.meet_type'
        db.alter_column(u'swimapp_meet', 'meet_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['swimapp.MeetType']))

        # Changing field 'Meet.start_date'
        db.alter_column(u'swimapp_meet', 'start_date', self.gf('django.db.models.fields.DateTimeField')(default=1))

        # Changing field 'Meet.team'
        db.alter_column(u'swimapp_meet', 'team_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['swimapp.Team']))

        # Changing field 'Meet.course_code_1'
        db.alter_column(u'swimapp_meet', 'course_code_1_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['swimapp.CourseCode']))

        # Changing field 'Meet.meet_config'
        db.alter_column(u'swimapp_meet', 'meet_config_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['swimapp.MeetConfig']))
