...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'swimapp_fileupload', (
            ...
            ('docfile', self.gf('django.db.models.fields.files.FileField')(max_length=300)),
            ('appuser', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.AppUser'])),
        ...
        db.send_create_signal('swimapp', ['FileUpload'])


    def backwards(self, orm):
        # Deleting model 'FileUpload'
        db.delete_table(u'swimapp_fileupload')
