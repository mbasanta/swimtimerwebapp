...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Meet.team'
        db.add_column(u'swimapp_meet', 'team',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['swimapp.Team']),
                      keep_default=False)

        # Adding field 'Team.team_color1'
        db.add_column(u'swimapp_team', 'team_color1',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Team.team_color2'
        db.add_column(u'swimapp_team', 'team_color2',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Team.latitude'
        db.add_column(u'swimapp_team', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Team.longitude'
        db.add_column(u'swimapp_team', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Meet.team'
        db.delete_column(u'swimapp_meet', 'team_id')

        # Deleting field 'Team.team_color1'
        db.delete_column(u'swimapp_team', 'team_color1')

        # Deleting field 'Team.team_color2'
        db.delete_column(u'swimapp_team', 'team_color2')

        # Deleting field 'Team.latitude'
        db.delete_column(u'swimapp_team', 'latitude')

        # Deleting field 'Team.longitude'
        db.delete_column(u'swimapp_team', 'longitude')
