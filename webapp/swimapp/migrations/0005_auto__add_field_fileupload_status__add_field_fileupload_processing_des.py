...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FileUpload.status'
        db.add_column(u'swimapp_fileupload', 'status',
                      self.gf('django.db.models.fields.CharField')(default='Pending', max_length=30),
                      keep_default=False)

        # Adding field 'FileUpload.processing_description'
        db.add_column(u'swimapp_fileupload', 'processing_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'FileUpload.time_start_processing'
        db.add_column(u'swimapp_fileupload', 'time_start_processing',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'FileUpload.time_end_processing'
        db.add_column(u'swimapp_fileupload', 'time_end_processing',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FileUpload.status'
        db.delete_column(u'swimapp_fileupload', 'status')

        # Deleting field 'FileUpload.processing_description'
        db.delete_column(u'swimapp_fileupload', 'processing_description')

        # Deleting field 'FileUpload.time_start_processing'
        db.delete_column(u'swimapp_fileupload', 'time_start_processing')

        # Deleting field 'FileUpload.time_end_processing'
        db.delete_column(u'swimapp_fileupload', 'time_end_processing')
    ...
    models = {
        ...
        'swimapp.fileupload': {
            ...
            'time_end_processing': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'time_entered': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'time_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'time_start_processing': ('django.db.models.fields.DateTimeField', [], {'null': 'True'})
        },
        'swimapp.meet': {
