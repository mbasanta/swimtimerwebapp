...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'swimapp_event', 'event_name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Event.event_name'
        db.alter_column(u'swimapp_event', 'event_name', self.gf('django.db.models.fields.CharField')(max_length=30))
