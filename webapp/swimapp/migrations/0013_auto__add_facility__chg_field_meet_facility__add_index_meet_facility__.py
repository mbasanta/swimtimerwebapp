...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'swimapp_facility', (
            ...
            ('length_1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='length_1_set', to=orm['swimapp.CourseCode'])),
        ...
        # Renaming column for 'Meet.facility' to match new field type.
        db.rename_column(u'swimapp_meet', 'facility', 'facility_id')
        # Changing field 'Meet.facility'
        db.alter_column(u'swimapp_meet', 'facility_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['swimapp.Facility']))
        # Adding index on 'Meet', fields ['facility']
        db.create_index(u'swimapp_meet', ['facility_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing index on 'Meet', fields ['facility']
        db.delete_index(u'swimapp_meet', ['facility_id'])
        ...
        # Renaming column for 'Meet.facility' to match new field type.
        db.rename_column(u'swimapp_meet', 'facility_id', 'facility')
        # Changing field 'Meet.facility'
        db.alter_column(u'swimapp_meet', 'facility', self.gf('django.db.models.fields.CharField')(max_length=45))
