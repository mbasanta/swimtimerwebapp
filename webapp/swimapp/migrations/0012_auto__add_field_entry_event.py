...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.event'
        db.add_column(u'swimapp_entry', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='events', to=orm['swimapp.Event']),
                      keep_default=False)
    ...
    models = {
        ...
        'swimapp.entry': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'events'", 'to': "orm['swimapp.Event']"}),
            'heat': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'entries'", 'to': "orm['swimapp.Heat']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
