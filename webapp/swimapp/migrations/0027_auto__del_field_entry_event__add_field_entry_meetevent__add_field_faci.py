...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Entry.event'
        db.delete_column(u'swimapp_entry', 'event_id')

        # Adding field 'Entry.meetevent'
        db.add_column(u'swimapp_entry', 'meetevent',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['swimapp.MeetEvent']),
                      keep_default=False)

        # Adding field 'Facility.lane_count'
        db.add_column(u'swimapp_facility', 'lane_count',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Entry.event'
        raise RuntimeError("Cannot reverse this migration. 'Entry.event' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Entry.event'
        db.add_column(u'swimapp_entry', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['swimapp.Event']),
                      keep_default=False)

        # Deleting field 'Entry.meetevent'
        db.delete_column(u'swimapp_entry', 'meetevent_id')

        # Deleting field 'Facility.lane_count'
        db.delete_column(u'swimapp_facility', 'lane_count')
