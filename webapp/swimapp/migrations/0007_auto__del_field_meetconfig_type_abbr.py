...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MeetConfig.type_abbr'
        db.delete_column(u'swimapp_meetconfig', 'type_abbr')


    def backwards(self, orm):
        # Adding field 'MeetConfig.type_abbr'
        db.add_column(u'swimapp_meetconfig', 'type_abbr',
