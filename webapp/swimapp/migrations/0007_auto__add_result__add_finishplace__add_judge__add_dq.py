...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Result'
        db.create_table(u'swimapp_result', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')()),
            ('result_type', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('entry', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['swimapp.Entry'])),
            ('timer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['swimapp.Judge'])),
        ...
        db.send_create_signal('swimapp', ['Result'])

        # Adding model 'FinishPlace'
        db.create_table(u'swimapp_finishplace', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('finish_place', self.gf('django.db.models.fields.IntegerField')()),
            ('entry', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['swimapp.Entry'])),
            ('judge', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['swimapp.Judge'])),
            ('time_entered', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('time_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('swimapp', ['FinishPlace'])

        # Adding model 'Judge'
        db.create_table(u'swimapp_judge', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.AppUser'], null=True, blank=True)),
            ('username', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('is_authenticated', self.gf('django.db.models.fields.BooleanField')()),
            ('is_override', self.gf('django.db.models.fields.BooleanField')()),
            ('time_entered', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('time_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('swimapp', ['Judge'])

        # Adding model 'DQ'
        db.create_table(u'swimapp_dq', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('swimapp', ['DQ'])


    def backwards(self, orm):
        # Deleting model 'Result'
        db.delete_table(u'swimapp_result')

        # Deleting model 'FinishPlace'
        db.delete_table(u'swimapp_finishplace')

        # Deleting model 'Judge'
        db.delete_table(u'swimapp_judge')

        # Deleting model 'DQ'
        db.delete_table(u'swimapp_dq')
