...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Meet.max_indiv_entries'
        db.add_column(u'swimapp_meet', 'max_indiv_entries',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Meet.max_relay_entries'
        db.add_column(u'swimapp_meet', 'max_relay_entries',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Meet.max_entries'
        db.add_column(u'swimapp_meet', 'max_entries',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Meet.max_indiv_entries'
        db.delete_column(u'swimapp_meet', 'max_indiv_entries')

        # Deleting field 'Meet.max_relay_entries'
        db.delete_column(u'swimapp_meet', 'max_relay_entries')

        # Deleting field 'Meet.max_entries'
        db.delete_column(u'swimapp_meet', 'max_entries')
    ...
    models = {
        ...
        'swimapp.meet': {
            ...
            'max_entries': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'max_indiv_entries': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'max_relay_entries': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
