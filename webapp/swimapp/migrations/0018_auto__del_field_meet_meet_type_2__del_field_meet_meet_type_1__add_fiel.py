...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Meet.meet_type_2'
        db.delete_column(u'swimapp_meet', 'meet_type_2_id')

        # Deleting field 'Meet.meet_type_1'
        db.delete_column(u'swimapp_meet', 'meet_type_1_id')

        # Adding field 'Meet.meet_masters'
        db.add_column(u'swimapp_meet', 'meet_masters',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Meet.meet_type'
        db.add_column(u'swimapp_meet', 'meet_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='meet_type_set', to=orm['swimapp.MeetType']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Meet.meet_type_2'
        db.add_column(u'swimapp_meet', 'meet_type_2',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='meet_type_2_set', null=True, to=orm['swimapp.MeetType'], blank=True),
                      keep_default=False)

        # Adding field 'Meet.meet_type_1'
        db.add_column(u'swimapp_meet', 'meet_type_1',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='meet_type_1_set', to=orm['swimapp.MeetType']),
                      keep_default=False)

        # Deleting field 'Meet.meet_masters'
        db.delete_column(u'swimapp_meet', 'meet_masters')

        # Deleting field 'Meet.meet_type'
        db.delete_column(u'swimapp_meet', 'meet_type_id')
    ...
    models = {
        ...
        'swimapp.meet': {
            ...
            'meet_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'meet_type_set'", 'to': "orm['swimapp.MeetType']"}),
