...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MeetEvent.event_number'
        db.add_column(u'swimapp_meetevent', 'event_number',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Event.event_number'
        db.delete_column(u'swimapp_event', 'event_number')


    def backwards(self, orm):
        # Deleting field 'MeetEvent.event_number'
        db.delete_column(u'swimapp_meetevent', 'event_number')

        # Adding field 'Event.event_number'
        db.add_column(u'swimapp_event', 'event_number',
