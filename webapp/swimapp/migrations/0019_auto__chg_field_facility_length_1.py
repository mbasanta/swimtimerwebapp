...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Facility.length_1'
        db.alter_column(u'swimapp_facility', 'length_1_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['swimapp.CourseCode']))

    def backwards(self, orm):

        # Changing field 'Facility.length_1'
        db.alter_column(u'swimapp_facility', 'length_1_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['swimapp.CourseCode']))
