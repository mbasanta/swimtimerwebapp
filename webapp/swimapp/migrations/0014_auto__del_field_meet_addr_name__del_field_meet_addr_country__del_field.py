...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Meet.latitude'
        db.delete_column(u'swimapp_meet', 'latitude')

        # Deleting field 'Meet.elevation'
        db.delete_column(u'swimapp_meet', 'elevation')

        # Deleting field 'Meet.addr_city'
        db.delete_column(u'swimapp_meet', 'addr_city')

        # Deleting field 'Meet.longitude'
        db.delete_column(u'swimapp_meet', 'longitude')

        # Deleting field 'Meet.addr_state'
        db.delete_column(u'swimapp_meet', 'addr_state')

        # Adding field 'Event.gender'
        db.add_column(u'swimapp_event', 'gender',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Meet.latitude'
        db.add_column(u'swimapp_meet', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Meet.elevation'
        db.add_column(u'swimapp_meet', 'elevation',
        ...
        # Adding field 'Meet.longitude'
        db.add_column(u'swimapp_meet', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'Event.gender'
        db.delete_column(u'swimapp_event', 'gender')
