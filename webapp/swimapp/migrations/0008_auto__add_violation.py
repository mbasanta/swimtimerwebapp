...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'swimapp_violation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('violation_number', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('server_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('stroke', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['swimapp.Stroke'], null=True, blank=True)),
        ...
        db.send_create_signal('swimapp', ['Violation'])

        # Adding M2M table for field meets on 'Violation'
        m2m_table_name = db.shorten_name(u'swimapp_violation_meets')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('violation', models.ForeignKey(orm['swimapp.violation'], null=False)),
            ('meet', models.ForeignKey(orm['swimapp.meet'], null=False))
        ))
        db.create_unique(m2m_table_name, ['violation_id', 'meet_id'])


    def backwards(self, orm):
        # Deleting model 'Violation'
        db.delete_table(u'swimapp_violation')

        # Removing M2M table for field meets on 'Violation'
        db.delete_table(db.shorten_name(u'swimapp_violation_meets'))
