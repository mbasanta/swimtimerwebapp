...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entry.seed_time'
        db.alter_column(u'swimapp_entry', 'seed_time', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Entry.heat'
        db.alter_column(u'swimapp_entry', 'heat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['swimapp.Heat'], null=True))

        # Changing field 'Entry.lane_number'
        db.alter_column(u'swimapp_entry', 'lane_number', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Entry.result_time'
        db.alter_column(u'swimapp_entry', 'result_time', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Entry.seed_time'
        db.alter_column(u'swimapp_entry', 'seed_time', self.gf('django.db.models.fields.FloatField')(default=-1))

        # Changing field 'Entry.heat'
        db.alter_column(u'swimapp_entry', 'heat_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['swimapp.Heat']))

        # Changing field 'Entry.lane_number'
        db.alter_column(u'swimapp_entry', 'lane_number', self.gf('django.db.models.fields.IntegerField')(default=-1))

        # Changing field 'Entry.result_time'
        db.alter_column(u'swimapp_entry', 'result_time', self.gf('django.db.models.fields.FloatField')(default=-1))
