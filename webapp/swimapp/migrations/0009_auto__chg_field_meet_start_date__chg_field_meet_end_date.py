...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'swimapp_meet', 'start_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Meet.end_date'
        db.alter_column(u'swimapp_meet', 'end_date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Meet.start_date'
        db.alter_column(u'swimapp_meet', 'start_date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Meet.end_date'
        db.alter_column(u'swimapp_meet', 'end_date', self.gf('django.db.models.fields.DateField')())
